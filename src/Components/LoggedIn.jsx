...
const LoggedIn = ({
  ...
  return (
    <div
      className={`content-start w-[40rem] h-[25rem] border-red-300 border scale  ${Dark ? "dark-mode" : "light-mode"
        }`}
      onClick={(e) => {
        e.preventDefault();
        setMenuActive(false);
    ...
    >
      ...
      {settingActive ? (
        ...
        <div>
          ...
          <div className="overflow-x-hidden overflow-y-auto h-[16.3rem]">{tab}</div>
        </div>
      )}{" "}
    </div>
  );
